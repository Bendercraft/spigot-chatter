...
public class CmdChatterHelp extends SubCommand
{
    private List<SubCommand> subCommands;

    public CmdChatterHelp(Logger logger, ResourceBundle messages, List<SubCommand> commands)
    {
    ...
    public void execute(CommandSender sender, List<String> args) throws ChatterCommandException
    {
        ...
        validatePermission(sender, "chatter.chatter.help");
        if (args.isEmpty())
        {
